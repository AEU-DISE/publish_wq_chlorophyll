...
```{r}
wq <- read.csv("nutr_wq_clean.csv")
phyto <- read.csv("phyto_clean.csv")
```
...
```{r}
wq_dt <- eml$dataTable(entityName = "../nutr_wq_clean.csv",
...
```{r}
phyto_dt <- eml$dataTable(entityName = "../phyto_clean.csv",
...
```{r}
chl_dt <- eml$dataTable(entityName = "../nutr_final.csv",
